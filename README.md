...
function addRow() {
    ...
    // ID_NO - generate ID on click/focus
    tr += "<td><input name='ID_NO' class='form-control form-control-md' onclick='generateId(this)' onfocus='generateId(this)'></td>";
    ...
    tr += "<option></option><option>BLEEDING HOLE</option><option>HOLE THROUGH</option><option>BLANK PUSH</option>";
    tr += "</select></td>";
    ...
    $.ajax({
        ...
        success: function (result_Exception_Cast) {
            ...
            for (var i = 0; ; i++) {
                ...
                var tr = "<tr>";
                tr += "<td><input name='ID_NO' class='form-control form-control-md' value='" + (r.ID_NO || "") + "' onclick='generateId(this)' onfocus='generateId(this)'></td>";
                tr += "<td><select name='TAPHOLE_NO' class='form-select form-select-md'>";
                tr += "<option></option>";
