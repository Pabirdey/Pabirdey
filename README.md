   <tbody>
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" name="CBF_ActOnDate" id="CBF_ActOnDate" /></td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" name="EBF_ActOnDate" id="EBF_ActOnDate" /></td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" name="FBF_ActOnDate" id="FBF_ActOnDate" /></td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" name="GBF_ActOnDate" id="GBF_ActOnDate" /></td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" name="HBF_ActOnDate" id="HBF_ActOnDate" /></td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" name="IBF_ActOnDate" id="IBF_ActOnDate" /></td>
