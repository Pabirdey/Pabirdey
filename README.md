  function Display_Tap_Hole_Details(lsSelectedFDate, IsSelectedFur) {
             ...
             $(document).on("click", "#TAP_Hot_Metal_Details,#Driling_Slag_Details", function () {
                debugger;
                // Remove highlight from all rows in both tables
                $("#TAP_Hot_Metal_Details,#Driling_Slag_Details").removeClass("highlight");

                // Get clicked row cast no
                let castNo = $(this).data("castno");

                // Highlight same cast no rows in both tables
                $('#TAP_Hot_Metal_Details-row[data-castno="' + castNo + '"]').addClass("highlight");
                $('#Driling_Slag_Details-row[data-castno="' + castNo + '"]').addClass("highlight");
            });
