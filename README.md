 function SaveData() {
            ...
            $.ajax({
                url: '/Granshot/Save_Granshot_Details',
                type: 'POST',
        ...
        <button class="btn btn-success btn-sm" style="margin-top:5px;font-family:Courier New, Courier, monospace;font-size:15px;font-weight:bold;" onclick="SaveData()">Save</button>
