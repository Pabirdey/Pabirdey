                ...
                using (OracleConnection conn = new OracleConnection(iMonitorWebUtils.msConRWString))
                {
                    ...
                    using (OracleCommand checkCmd = new OracleCommand(checkSql, conn))
                    {
                        ...
                        else
                        {
                            ...
                            BM_MGO_PLANT,BM_C_PLANT,BM_OIL_PLANT,BM_FEO_PLANT,BM_SIO2_PLANT_LOI,BM_CAO_PLANT_LOI,BM_PHOS_PLANT_LOI,BM_AL2O3_PLANT_LOI,BM_MGO_PLANT_LOI,BM_C_PLANT_LOI,BM_OIL_PLANT_LOI,BM_FEO_PLANT_LOI) 
                            ...
                            :BM_OIL_PLANT,:BM_FEO_PLANT,:BM_SIO2_PLANT_LOI,:BM_CAO_PLANT_LOI,:BM_PHOS_PLANT_LOI,:BM_AL2O3_PLANT_LOI,:BM_MGO_PLANT_LOI,:BM_C_PLANT_LOI,:BM_OIL_PLANT_LOI,:BM_FEO_PLANT_LOI)";
