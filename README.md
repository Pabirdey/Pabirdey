 private void LoadActualFromLadle(OracleConnection con,DateTime dt,string furnace,BFViewModel model)
        {
            try
            {                
                string query = @"SELECT nvl(SUM(NET_WT),0) FROM DEMO.T_LADLE_DETAILS  WHERE LADLE_FLEND_TIME>=:fromDate
                    ...
                    case "C":                        
                        ...
                        else
                        {
                            if (model.ActualC != null)
                            {
                                ...
                                model.REPORTED_C_TD = model.REPORTED_C_TD + model.ReportedC;
                    ...
                    case "E":
                        ...
                        else
                        {
                            if (model.ActualE != null)
                            {
                                ...
                                model.REPORTED_E_TD = model.REPORTED_E_TD + model.ReportedE;
                    ...
                    case "F":
                        ...
                        else
                        {
                            if (model.ActualF != null)
                            {
                                ...
                                model.REPORTED_F_TD = model.REPORTED_F_TD + model.ReportedF;
