 <div class="form-section">
            <div class="row g-0">
                ...
                <div class="table-responsive scrollable-table" style="max-height:165px;">
        ...
        <div class="form-section">
            <div class="row g-0">
                ...
                <div class="table-responsive scrollable-table" style="max-height:175px;">
                    <table class="table table-bordered text-center align-middle" id="Driling_Slag_Details">
                        <thead>
                            <tr>
                                <th class="Long_Heading_Medium freeze-col" style="width:80px;">Cast No</th>
                                <th class="Long_Heading_Medium" style="width:60px;">Drill Dia</th>
                                <th class="Long_Heading_Medium" style="width:140px;">Drill Type</th>
                                <th class="Long_Heading_Medium">Total Drilling Time</th>
                                <th class="Long_Heading_Medium" style="width:60px;">No of Drill Bars</th>
                                <th class="Long_Heading_Medium" style="width:60px;">No of Drill Bits</th>
                                ...
                                <th class="Long_Heading_Medium" style="width:110px;">Color of Furnes During Drilling</th>
                                <th class="Long_Heading_Medium" style="width:80px;">Slag Start Time</th>
                                <th class="Long_Heading_Medium" style="width:80px;">Slag Time Ratio</th>
                                <th class="Long_Heading_Medium">Slag Retention Time</th>
                                <th class="Long_Heading_Medium" style="width:80px;">No of Slag Ladle</th>
                                ...
                                <th class="Long_Heading_Medium" style="width:60px;">Slag Rate</th>
                                <th class="Long_Heading_Medium" style="width:60px;">Total Slag</th>
                            </tr>
                        </thead>
                        <tbody></tbody>
                    </table>
