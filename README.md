...
p_Source:='RMBB_KNR';
  ...
  -- Select COUNT(*) into vCOUNT From imtg.T_PILE_RAWMAT_QUANTITY_NEW Where PILE_NO='112526' and SOURCE='RMBB_KNR';
   If vCOUNT=0 Then 
    Insert into imtg.T_PILE_RAWMAT_QUANTITY_NEW(PILE_NO,SOURCE, noa_fines, joda_fines, kb_fines, yard_fines)
    Values(p_PileNo,p_Source,p_NoaFines,p_JodaFines,p_KBFines,p_YardFines);
   Else
