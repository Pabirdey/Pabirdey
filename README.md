                ...
                <table class="table table-bordered text-center" style="border:2px solid black;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" oninput="calculateAF_ActOnDate()" name="CBF_ActOnDate" id="CBF_ActOnDate" /></td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" oninput="calculateAF_ActOnDate()" name="EBF_ActOnDate" id="EBF_ActOnDate" /></td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" oninput="calculateAF_ActOnDate()" name="FBF_ActOnDate" id="FBF_ActOnDate" /></td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" oninput="calculateAF_ActOnDate()" name="GBF_ActOnDate" id="GBF_ActOnDate" /></td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" oninput="calculateAF_ActOnDate()" name="HBF_ActOnDate" id="HBF_ActOnDate" /></td>
                        ...
                        <tr>
                            ...
                            <td><input class="form-control" type="text" value="@Model.ACT_ONDT" oninput="calculateAF_ActOnDate()" name="IBF_ActOnDate" id="IBF_ActOnDate" /></td>
...
<script>
    ...
    function calculateAF_ActOnDate() {
        debugger;
        let val1 = parseFloat(document.getElementById('CBF_ActOnDate').value) || 0;
        let val2 = parseFloat(document.getElementById('EBF_ActOnDate').value) || 0;
        let val3 = parseFloat(document.getElementById('FBF_ActOnDate').value) || 0;
        let val4 = parseFloat(document.getElementById('GBF_ActOnDate').value) || 0;
        let val5 = parseFloat(document.getElementById('HBF_ActOnDate').value) || 0;
        let val6 = parseFloat(document.getElementById('IBF_ActOnDate').value) || 0;

        // Sum the values
        let sum = val1 + val2 + val3 +val4+val5+val6;

        // Display in the fourth text box
        document.getElementById('CtoFBF_ActOnDate').value = sum;
