    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" id="TXT_RPT_G"/></td>
                                            <td><input type="text" class="form-control" id="TXT_RPT_G_TD" readonly /></td>
                                            <td><input type="text" class="form-control" id="TXT_BAL_G" readonly /></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" id="TXT_RPT_H" /></td>
                                            <td><input type="text" class="form-control" id="TXT_RPT_H_TD" readonly /></td>
                                            <td><input type="text" class="form-control" id="TXT_BAL_H" readonly /></td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td><input type="text" class="form-control" id="TXT_RPT_I" /></td>
                                            <td><input type="text" class="form-control" id="TXT_RPT_I_TD" readonly /></td>
                                            <td><input type="text" class="form-control" id="TXT_BAL_I" readonly /></td>
                                        </tr>   
                                        <tr>
                                            <td>C-F</td>
                                            ...
                                            <td><input type="text" class="form-control" id="DisplayBalance" readonly /></td>
                                        </tr>
                                        <tr>
                                            <td>C-G</td>
                                            ...
                                            <td><input type="text" class="form-control" id="DISPLAY_BAL_G" readonly /></td>
                                        </tr>                                        
                                        <tr>
                                            <td>C-H</td>
                                            ...
                                            <td><input type="text" class="form-control" id="DISPLAY_BAL_H" readonly /></td>
                                        </tr>
                                        <tr>
                                            <td>C-I</td>
                                            ...
                                            <td><input type="text" class="form-control" id="DISPLAY_BAL_I" readonly /></td>
                                        </tr>                                                                 
                                    </tbody>
