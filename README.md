    ...
    try
    {
        ...
        switch (furnace)
        {
            case "C":
                ...
                model.ACTUAL_C_TD =
                    actTD + (model.ActualC ?? 0);

                model.REPORTED_C_TD =
                    repTD + (model.ReportedC ?? 0);
            ...
            case "E":
                ...
                model.ACTUAL_E_TD =
                    actTD + (model.ActualE ?? 0);

                model.REPORTED_E_TD =
                    repTD + (model.ReportedE ?? 0);
            ...
            case "F":
                ...
                model.ACTUAL_F_TD =
                    actTD + (model.ActualF ?? 0);

                model.REPORTED_F_TD =
                    repTD + (model.ReportedF ?? 0);
