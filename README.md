...
rs.Open sqlstr, con, adOpenStatic, adLockOptimistic
      If IsNull(rs!TLC_END_DATE) = True Then
        Sheets("Report").Cells(i, 2) = Format(rs!tlc_ST_DATE, "DD-MMM-YYYY HH:MM:SS")
        Else
        Sheets("Report").Cells(i, 2) = Format(rs!TLC_END_DATE, "DD-MMM-YYYY HH:MM:SS")
       End If
